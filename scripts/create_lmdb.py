...
def main():
    dataset = 'GOPRO'  # vimeo90K | REDS | general (e.g., DIV2K, 291) | DIV2K_demo |test
...
def REDS(mode):
    ...
    if mode == 'sharp':
        ...
        img_folder = '/home/ubuntu/SRN-Deblur/testing_set/REDS_val/val_sharp'
        lmdb_save_path = '../../datasets/REDS/val_sharp_wval.lmdb'
        H_dst, W_dst = 720, 1280
    elif mode == 'val_blur':
        img_folder = '/home/ubuntu/SRN-Deblur/testing_set/REDS_val/val_blur'
        lmdb_save_path = '../../datasets/REDS/val_blur_wval.lmdb'
        H_dst, W_dst = 720, 1280
    n_thread = 40
    ########################################################
    if not lmdb_save_path.endswith('.lmdb'):
...
def GOPRO(mode):
    ...
    BATCH = 5000  # After BATCH images, lmdb commits, if read_all_imgs = False
    if mode == 'train_sharp':
        img_folder = '../../datasets/GOPRO/train_regrouped/sharp'
        lmdb_save_path = '../../datasets/GOPRO/train_sharp.lmdb'
        H_dst, W_dst = 720, 1280
    elif mode == 'train_blur_linear':
        img_folder = '../../datasets/GOPRO/train_regrouped/blur'
        lmdb_save_path = '../../datasets/GOPRO/train_blur_linear.lmdb'
        H_dst, W_dst = 720, 1280
    n_thread = 40
    ########################################################
    if not lmdb_save_path.endswith('.lmdb'):
